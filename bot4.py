# -*- coding: utf-8 -*-
"""
bot4 — کپی bot2 با اکانت و چنل/گروه جدید (1209688673 / 2056532687)
...
# ===== کانفیگ ربات دوم =====
SOURCE_CHANNELS = {-1001209688673}        # کانال: 1209688673
COMMENT_GROUPS = {-1002056532687}   # گروه: 2056532687
DELETE_GROUPS = {-1002056532687}    # همان گروه برای خود-حذفی
TRIGGER_WORDS = {
...
async def apply_profile_amirali():
    ...
    try:
        ...
        print("[PROFILE -> AmirAli] name=𝑩𝒍𝒂𝒄𝒌 𝑳𝒖𝒏𝒈 𝑴𝒐𝒓𝒈𝒂𝒏 photo=hidden bio=hidden", flush=True)
    except Exception as exc:
